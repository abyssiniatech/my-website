  ...
  return (
    <MotionSection id="about" className="section container">
      ...
      <p className="subtle mt-2 max-w-3xl">
        I am a multidisciplinary professional with over 10 years of experience in education and leadership, and 4+ years as a full-stack developer. 
        Alongside my technical expertise, I bring strong skills in graphic design and video editing, enabling me to create both functional and visually engaging solutions.
        <br /><br />
        I am a fast learner who thrives on problem-solving, mentoring students, and collaborating with teams. My passion lies in turning ideas into practical products that make a real impact.
      </p>
